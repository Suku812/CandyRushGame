...
public class CandyRushGame extends JPanel implements Runnable,KeyListener
{
	private Thread t;
	private Ball ball;
	JLabel boul;
	...
	public CandyRushGame(Main main){
		...
		boul = new JLabel(new ImageIcon("C:\\Bowl.png"));
		...
		for(int i=0;i<5;i++){
			labelLife[i] = new JLabel(new ImageIcon("C:\\heart.png"));
